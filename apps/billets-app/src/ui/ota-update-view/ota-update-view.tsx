...
export const OtaUpdateView = ({ updateProgressPercentage }: { updateProgressPercentage: number }) => {
  ...
  return (
    <SafeAreaProvider>
      <CommonScreenLayout style={{ alignItems: 'center', justifyContent: 'center', paddingHorizontal: 48 }}>
        <FastImage
        ...
        <View style={{ marginTop: 36, width: '100%', alignItems: 'center', justifyContent: 'center' }}>
          <View style={{ width: '100%', backgroundColor: colors.oc.white.value, height: 8, borderRadius: 12 }}>
            <View
              style={{
          ...
          <View style={{ marginTop: 24 }}>
            <Text
              weight="medium"
              style={{ fontSize: 14, color: semantics.foreground[1], textAlign: 'center', lineHeight: 24 }}
            >
