...
export const TicketPriceListItem = ({ item, ticketId }: { item: TicketPrice; ticketId: string }) => {
    ...
    deleteTicketPrice({
      ...
      update: (cache, { data }) => {
        if (data?.removeConcertTicketPrice?.__typename === 'TicketPrice') {
          ...
          const cacheData = cache.readQuery<ConcertTicketPricesQuery, ConcertTicketPricesQueryVariables>({
              ...
              data: {
                ...
                concertTicketPrices: {
                  ...
                  list: cacheData.concertTicketPrices.list
                    ? cacheData.concertTicketPrices.list.filter((price) => price?.id !== deletedTicketPriceId)
                    : [],
                },
              },
            })
  ...
  return (
    <>
      <StyledTicketPriceItemContainer>
        ...
        <Button theme={'transparent'} onClick={() => setDeleteConfirmModalVisible(true)} style={{ marginLeft: 'auto' }}>
          ❌
        </Button>
      </StyledTicketPriceItemContainer>
