...
export const metadata: Metadata = {
  title: `Products | ${SERVICE_NAME}`,
  description: '예술적인 삶을 더 쉽게, COLDSURF의 제품을 만나보세요.',
};
    ...
    <>
      ...
      <ProductCardListLayout>
        <ProductCard
          ...
          longDescription={`많은 밴드들이 사라져가는 현실이 안타까워서 ${SERVICE_NAME}를 만들었습니다.\n밴드는 제 청춘을 치유해준 존재였습니다.\n${SERVICE_NAME}는 로컬 공연장을 지원해, 밴드가 자신이 자란 무대에서 성장할 수 있도록 돕습니다.`}
