...
const sectionContents = [
  [
    ...
    {
      type: 'paragraph',
      text: `I created Billets because I felt sad that lots of bands are disappearing.\nBands always healed my soul in my youth.\nBillets support local venues, so bands can be grown up from their locals. (essentially)`,
    },
  ],
  [
    {
  ...
  [
    ...
    {
      type: 'paragraph',
      text: `Billets is one of the products by `,
    },
    {
      type: 'link',
      text: 'COLDSURF',
    ...
    <>
      <SectionDivider $topSpace={false}>
        <PageTopSlideUpMotion>
          <StyledTopTitleText as="h1">Introduce Billets</StyledTopTitleText>
        </PageTopSlideUpMotion>
      </SectionDivider>
